...
ActiveRecord::Schema.define(version: 2021_09_08_091648) do
  ...
  create_table "celo_chains", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "last_event_tweet_at"
  ...
  create_table "crypto_chains", force: :cascade do |t|
    t.string "name", null: false
    t.boolean "testnet", null: false
    t.bigint "history_height", default: 0
    t.datetime "last_sync_time"
    ...
    t.string "last_round_state", default: ""
    t.string "ext_id"
    t.string "token_denom", default: "cro"
    t.bigint "token_factor", default: 0
    t.string "sdk_version"
    t.text "notes"
    t.boolean "use_ssl_for_lcd", default: false
  ...
  create_table "persistence_chains", force: :cascade do |t|
    t.string "name", null: false
    t.boolean "testnet", null: false
    t.bigint "history_height", default: 0
    t.datetime "last_sync_time"
  ...
  create_table "prime_analytics_data_points", force: :cascade do |t|
    t.date "date"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "figment_commission_rate"
    t.float "figment_effective_rate"
    t.float "investor_rewards_net_apr"
    t.float "figment_daily_commission"
    t.index ["date"], name: "index_prime_analytics_data_points_on_date", using: :brin
    t.index ["network_id"], name: "index_prime_analytics_data_points_on_network_id"
  end
  ...
  create_table "skale_chains", force: :cascade do |t|
    t.string "name", null: false
    t.string "slug", null: false
    t.string "api_url", null: false
    t.boolean "testnet", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_skale_chains_on_slug"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "prime_eth_staking_enabled", default: false, null: false
    t.text "prime_eth_staking_customer_id"
    t.string "otp_secret_key"
  ...
  add_foreign_key "prime_analytics_data_points", "prime_networks", column: "network_id"
