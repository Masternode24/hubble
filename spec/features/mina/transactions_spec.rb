...
describe 'mina transactions', :vcr do
    ...
    it 'redirects to the transaction page' do
      within '.transactions-search-results' do
        within page.find('tbody > tr:first-child') do
          click_on 'details'
          expect(page).to have_current_path "/mina/chains/#{chain.slug}/transactions/CkpZYwZYxj8uwsEmT4MBxrHuuAtPfwV31k9bj1P12wgyRFBaoWhuC"
        end
      end
    end
  end
