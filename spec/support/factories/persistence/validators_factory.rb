FactoryBot.define do
  factory :persistence_validator_prestart, class: 'Persistence::Validator' do
...
FactoryBot.define do
  factory :persistence_validator_synced, class: 'Persistence::Validator' do
    address { 'AC2D56057CD84765E6FBE318979093E8E44AA18F' }
    ...
    owner { 'persistence1zes570lfry2vpk9je9g2pt3w0ychvy2rtd70yr' }
    moniker { '🐠stake.fish' }
  end
end
